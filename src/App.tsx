        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
              Recibe hoy estos {BONUSES.length} Bonos Exclusivos (100% Gratis)
            </h2>
            <p className="text-sm text-slate-600 leading-relaxed max-w-2xl mx-auto">
              Solo tienes que comprar la biblioteca de entrenamientos hoy mismo para recibir de regalo estos manuales metodológicos y recursos adicionales de gran valor.
            </p>
          </div>
